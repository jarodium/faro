...
class Mapbox {
	...
	protected $versions = array('geocoder'=>'v5',"directions" => 'v5'); //versions for endpoint
	...
	**/
	...
	public function directions($origin, $destination, $travel,$params = []) {
		//$params = array();
		$url = $this->home."/directions/".$this->versions["directions"]."/mapbox/".$travel."/".$origin.";".$destination;
